...
public class DataVisualization {
            ...
            if(input == -1){
             ...
             switch (input) {
                 case 1:
                     ...
                     displayActivityLogsFarm(farmId);    
                     break;
                 ...
                 case 2:
                     ...
                     displayActivityLogsFarm(farmerId);    
                     break;  
                 ...
                 case 3:
                     ...
                     displayActivityLogsFarmType(farmId, typeName);
                     break;
                 case 4:
                     System.out.print("\nEnter Farm ID: ");
                     do{
                     ...
                     displayActivityLogsFarmTypeDate(farmId, typeName, fromDate, toDate);
                     break;
                 case 5:
                     System.out.print("\nEnter Farm ID: ");
                     do{
                     ...
                     displayActivityLogsFarmTypeDateFieldRow(farmId, typeName, fromDate, toDate, fieldNumber, rowNumber);
                     break;
                 default:
    ...
    */
    ...
    public void displayActivityLogsFarm(String farmId) {
        // Get activities based on farm id
        ResultSet rs = db.SELECTrs("SELECT * FROM activities" +
    ...
    public void displayActivityLogsFarmer(String farmerId) {
    ...
    public void displayActivityLogsFarmType(String farmId, String type) {
    ...
    public void displayActivityLogsFarmTypeDate(String farmId, String type, String fromDate, String toDate) {
        // Get activities based on farm id & type of plant / fertilizer / pesticide
        ResultSet rs = db.SELECTrs(String.format(
    ...
    public void displayActivityLogsFarmTypeDateFieldRow(String farmId, String type, String fromDate, String toDate, String fieldNumber, String rowNumber) {
        ...
        ResultSet rs = db.SELECTrs(String.format(
                    "SELECT * FROM activities WHERE farm_id_fk = %s AND LOWER(type) = LOWER('%s') AND date >= '%s' AND date <= '%s' AND field = %d AND row = %d ORDER BY date ASC",
